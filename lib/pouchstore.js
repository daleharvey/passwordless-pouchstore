...
/**
 */
function PouchStore(connection, options) {
...
util.inherits(PouchStore, TokenStore);
 ...
 */
PouchStore.prototype.authenticate = function(token, uid, callback) {
 ...
 */
PouchStore.prototype.storeOrUpdate = function(token, uid, msToLive,
                                                originUrl, callback) {
 ...
 */
PouchStore.prototype.invalidateUser = function(uid, callback) {
  if (!uid || !callback) {
 ...
 */
PouchStore.prototype.length = function(callback) {
  this.getDB(function(db) {
...
PouchStore.prototype.getDB = function(callback) {
  if (this.db) {
